...
import org.neo4j.mapper.core.schema.GeneratedValue;
import org.neo4j.mapper.core.schema.IdGenerator;
...
public final class IdDescription {
	 ...
	 */
	private @Nullable
	final Class<? extends IdGenerator<?>> idGeneratorClass;
	...
	public boolean isInternallyGeneratedId() {
		return //this.idGeneratorClass == org.springframework.data.neo4j.core.schema.GeneratedValue.InternalIdGenerator.class
				// ||
		this.idGeneratorClass == GeneratedValue.InternalIdGenerator.class;
	}
	...
	public boolean isExternallyGeneratedId() {
		return (this.idGeneratorClass != null
				&& this.idGeneratorClass != GeneratedValue.InternalIdGenerator.class)
				//&& this.idGeneratorClass != org.springframework.data.neo4j.core.schema.GeneratedValue.InternalIdGenerator.class)
				||
