...
public @interface GeneratedValue {
	 ...
	 * @see #generatorClass()
	 */
	Class<? extends IdGenerator<?>> value() default InternalIdGenerator.class;
	...
	/**
	 * This generator is automatically applied when a field of type {@link UUID} is annotated with
